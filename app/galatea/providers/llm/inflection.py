...
def create(cfg: dict) -> "InflectionLLM":
    """Factory for the provider registry: build InflectionLLM from a config `llm` section."""
    return InflectionLLM(
        model=cfg.get("model") or "Pi-3.1",
