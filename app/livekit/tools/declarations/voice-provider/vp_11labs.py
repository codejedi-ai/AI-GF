...
class ElevenLabsSTT:
    """STT using ElevenLabs API (placeholder)."""
    def __init__(self, **kwargs):
        logger.warning("ElevenLabs STT is not yet natively supported in LiveKit-plugins-elevenlabs.")
        raise NotImplementedError("ElevenLabs STT integration is pending.")
